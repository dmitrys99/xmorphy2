...
{
    using Row = std::vector<variant<std::string, const char *, std::string_view, tabulate::Table>>;
...
std::string PrettyFormater::format(const std::vector<WordFormPtr> & forms) const
{
    ...
    using Row = std::vector<variant<std::string, const char *, std::string_view, Table>>;
